...
namespace PBIManagerWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<UrlsConfig>(Configuration.GetSection("ServiceUrls"));

            services.AddHttpClient<ICapacityService, CapacityService>();
            services.AddHttpClient<IAzureService, AzureService>();
            services.AddHttpClient<IWorkspaceService, WorkspaceService>();
        }
